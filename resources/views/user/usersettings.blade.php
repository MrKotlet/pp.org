    ...
    <div class="col-10 col-lg-7 g-0 mx-auto ">
        ...
        <div class="">
            ...
            <div class="p-4">
                ...
                <form action="{{ action ('HomeController@editemail')}}" method="POST" role="form" id="email">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control" value="{{$user->email}}"
                                   id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter new email">
                        </div>
